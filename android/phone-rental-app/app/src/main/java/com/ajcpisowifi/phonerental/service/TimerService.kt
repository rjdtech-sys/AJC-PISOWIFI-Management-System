...
class TimerService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START = "com.ajcpisowifi.phonerental.TIMER_START"
        const val ACTION_STOP = "com.ajcpisowifi.phonerental.TIMER_STOP"
        ...
        tickJob = scope.launch {
            while (isActive) {
                ...
                if (diff <= 0) {
                    ...
                    sendBroadcast(Intent("com.ajcpisowifi.phonerental.SESSION_EXPIRED"))
                    stopSelf()
                    break
                }
    ...
    private fun buildNotification(text: String): Notification {
        return NotificationCompat.Builder(this, CHANNEL_ID)
            .setContentTitle("AJC Phone Rental")
            .setContentText(text)
