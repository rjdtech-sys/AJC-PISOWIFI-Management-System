package com.ajcpisowifi.phonerental.util
    ...
    private fun installApkSilently(apkFile: File): Boolean {
        return try {
            ...
            val intent = Intent(context, javaClass).apply {
                action = "com.ajcpisowifi.phonerental.INSTALL_COMPLETE"
            }
    ...
    private fun triggerInstall(apkFile: File) {
        try {
            ...
            val isAdminActive = devicePolicyManager.isAdminActive(
                android.content.ComponentName(context, com.ajcpisowifi.phonerental.admin.KioskDeviceAdmin::class.java)
            )
