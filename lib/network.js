  ...
  try {
    ...
    for (const user of users) {
      ...
      if (isExpired && poolStartInt !== null && poolEndInt !== null) {
        ...
        // Expired user but NO expired pool configured - SKIP this user (block access)
        console.log(`[PPPoE-Server] Skipping expired user "${username}" - no expired pool configured`);
        continue;
      } else {
