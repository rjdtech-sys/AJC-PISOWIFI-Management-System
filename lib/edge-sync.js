...
class EdgeSync {
  constructor() {
    ...
    this.syncEnabled = true; // Default to enabled
    this.isInitialized = false;

    this.loadQueue();
    this.loadLocalIdentity();
    // this.loadCentralizedKey(); // Moved to init()
    ...
    // this.init(); // Init must be called manually after DB is ready
  }
  ...
  async init() {
    ...
    try {
      ...
      await this.loadCentralizedKey(); // Load sync state after database setup
