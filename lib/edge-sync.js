...
// Status sync interval (60 seconds - increased from 30s for CPU optimization)
const STATUS_SYNC_INTERVAL = 60000;

const CLOUD_WIFI_DEVICES_PULL_INTERVAL = 120000; // 120s - increased from 60s for CPU optimization
